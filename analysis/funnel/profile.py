    ...
    out = [
        ...
        _decision(
            ...
            ["Use the price logged on each event.",
             "Use the price on the purchase event for purchases and the cart event for carts.",
        ...
        _decision(
            ...
            ["Use view, cart, and purchase only; ignore other levels.",
             "Use other levels (for example, remove_from_cart) as a separate abandonment signal.",
